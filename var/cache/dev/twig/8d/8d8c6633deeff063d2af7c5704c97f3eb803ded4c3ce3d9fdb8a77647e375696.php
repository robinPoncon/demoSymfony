...
class __TwigTemplate_fda41c1dc465be90043c8a1fb99f35ed887be36224f2e291535b6ba90c47d8f2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "confirm_password", [], "any", false, false, false, 12), 'row', ["label" => "Confirmer le mot de passe", "attr" => ["placeholder" => "Répéter le mot de passe"]]);
        echo "
...
";
    ...
    {
        return array (  97 => 16,  90 => 12,  86 => 11,  82 => 10,  78 => 9,  73 => 7,  68 => 4,  58 => 3,  35 => 1,);
    }
...
\t{{ form_row(form.email, {\"label\": \"Adresse email\", \"attr\": {\"placeholder\": \"Votre adresse mail\"}})  }}
\t{{ form_row(form.password, {\"label\": \"Mot de passe\", \"attr\": {\"placeholder\": \"Mot de passe\"}}) }}
\t{{ form_row(form.confirm_password, {\"label\": \"Confirmer le mot de passe\", \"attr\": {\"placeholder\": \"Répéter le mot de passe\"}}) }}

\t<button type=\"submit\" class=\"btn btn-success\"> Inscription !</button>

\t{{ form_end(form) }}

{% endblock %}", "security/registration.html.twig", "/Users/robinponcon/Sites/demo/templates/security/registration.html.twig");
    }
}
